    ...
    <section class="col-12" style="margin-top: 15px">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-12 invoice-col">
                ...
                <address>
                    <b>Mã xuất kho: {{ isset($warehouse) ? $warehouse->warehouse_no : '' }}</b><br>
                    <span>Nội dung xuất :</span> {{ isset($warehouse) ? $warehouse->name : '' }}<br>
                    ...
                    @if (isset($warehouse->products))
                        ...
                        @foreach($warehouse->products as $key => $product)
                            <tr>
                                ...
                                <td style="vertical-align: middle">{{ isset($product->branchExport) ? $product->branchExport->name : '' }}</td>
