                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->first('name') ? 'has-error' : '' }} ">
                            <label for="inputEmail3" class="control-label default">Nội dung xuất hàng <sup class="text-danger">(*)</sup></label>
                            <div>
                                <input type="text" maxlength="100" class="form-control"  placeholder="Nội dung xuất hàng" name="name" value="{{ old('name', isset($warehouse) ? $warehouse->name : '') }}" required>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered" id = "table-import-product">
                            ...
                            <tr>
                                ...
                                <th class="text-center"> Đến chi nhánh / Kho</th>
                                        ...
                                        <tr class="item-import">
                                            ...
                                            <td style="vertical-align: middle">
                                                <select name="customers[]" id="" class="form-control" required>
                                                    ...
                                                    @if($branches)
                                                        @foreach($branches as $key => $branch)
                                                            <option value="{{ $branch->id }}" {{ $item->export_branch_id == $branch->id ? "selected" : '' }}>{{ $branch->name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </td>
                        ...
                        <div class="box-body text-right" style="margin-top: 15px">
                            <button type="button" class="btn btn-success mg-t-20 mg-b-15 btn-add-row-export" url="{{ route('warehouse.export.row') }}"><i class="fa fa-plus-circle"></i> Thêm sản phẩm</button>
                        </div>
                    </div>
                    <!-- /.card-body -->
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="text-align: right;">
                        <div class="btn-set">
                            ...
                            <a href="{{ route('warehouse.export.index') }}">
