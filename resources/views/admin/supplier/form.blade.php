                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->first('name') ? 'has-error' : '' }} ">
                            ...
                            <div>
                                <input type="text" maxlength="100" class="form-control"  placeholder="Tên nhà cung cấp" name="name" value="{{ old('name',isset($supplier) ? $supplier->name : '') }}">
                        ...
                        <div class="form-group {{ $errors->first('email') ? 'has-error' : '' }} ">
                            ...
                            <div>
                                <input type="email" maxlength="100" class="form-control"  placeholder="Email" name="email" value="{{ old('email',isset($supplier) ? $supplier->email : '') }}">
                        ...
                        <div class="form-group {{ $errors->first('phone') ? 'has-error' : '' }} ">
                            ...
                            <div>
                                <input type="text" maxlength="100" class="form-control"  placeholder="Số điện thoại" name="phone" value="{{ old('phone',isset($supplier) ? $supplier->phone : '') }}">
