            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('selling.index') }}">Bán Hàng</a></li>
                ...
                <div class="card-body">
                    <form action="">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-3">
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control mg-r-15" placeholder="Tên khách hàng ...">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-3">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools">
                                <div class="btn-group">
                                    <a href="{{ route('selling.create') }}"><button type="button" class="btn btn-block btn-info"><i class="fa fa-plus"></i> Tạo mới</button></a>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                ...
                                @if (!$warehouses->isEmpty())
                                    ...
                                    @foreach($warehouses as $warehouse)
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle">{{ isset($warehouse->selling) ? $warehouse->selling->name : '' }}</td>
                                            ...
                                            <td class="text-center" style="vertical-align: middle">
                                                <a class="btn btn-primary btn-sm" href="{{ route('selling.update', $warehouse->id) }}">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <a class="btn btn-danger btn-sm btn-delete btn-confirm-delete" href="{{ route('warehouse.export.delete', $warehouse->id) }}">
                                                    <i class="fas fa-trash"></i>
                                                </a>
                                                <a href="{{ route('selling.invoice', $warehouse->id) }}" class="btn btn-success btn-sm" title="Hóa đơn"><i class="fa fa-fw fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        @php $i++ @endphp
                                    @endforeach
