                                    ...
                                    @if (!$users->isEmpty())
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td>{{ $user->email }}</td>
                                                <td>{{ $user->phone }}</td>
                                                <td>{{ isset($user->shop) ? $user->shop->name : '' }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{ route('user.update.status', $user->id) }}" class="update-status update-status-{{ $user->id }}" >
                                                        <button type="button" class="btn btn-block {{ $classStatus[$user->status] }} btn-xs" style="margin: auto">{{ $status[$user->status] }}</button>
                                                    </a>
                                                </td>
