...
@section('title', 'Thông tin tài khoản | Quản lý phiếu')
@section('content')
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="settings">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName2" placeholder="Address" name="address" value="{{old('address', isset($user->address) ? $user->address : '')}}">
                                                <span class="text-danger "><p class="mg-t-5">{{ $errors->first('phone') }}</p></span>
                                            </div>
                                        </div>
