...
if (!function_exists('formatDate')) {
    function formatDate(string $stringDate) {
        return date('Y-m-d H:i', strtotime($stringDate));
    }
}
...
function genderCode($textCode, $id)
{
    return $textCode.str_pad($id, 6, '0', STR_PAD_LEFT);
}

function randomOderNo ()
{
    $value = (microtime(true) * 10000) + random_int(0, 99999);
    return strval($value);
}
